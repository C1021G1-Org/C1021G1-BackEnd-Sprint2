...
public interface NewsRepository extends JpaRepository<News, Long> {
    ...
    void createNews(String code, String date, String author, Boolean delFlag, String title, String img, String description, NewsType idNewsType);
    ...
    void updateNews(String date, String author, String title, String img, String description, NewsType idNewsType, Long id);
